function [x, seg, u, seg_all] = segment(chr, arm, pos, k, d, dd, log_pr_gg, loglik_su, loglik_s, params, options)
...
for lev = 2 : n_lev
	...
	if sum(xd) == 0
		...
		seg{lev} = findmultisegments(chr, arm, pos, v{lev}, xd, x{lev}, x{lev-1}, u{lev}, loglik_su, [], options, params);
	end
