...
options.infile = '/data/cyau/wgs500/pileup/snp/FH_BLC_4070T.txt'; % input data file
options.normalfile = '/data/cyau/wgs500/pileup/snp/FH_BLC_4070N.txt'; % input data file

% 24-26
options.samplename = 'FH_BLC_2010T_2';
options.infile = '/data/cyau/wgs500/pileup/snp/FH_BLC_2010T.txt'; % input data file
options.normalfile = '/data/cyau/wgs500/pileup/snp/FH_BLC_2010N.txt'; % input data file



tic
oncoseq( 	'--read_depth_range', '[24:26]', ...
			'--chr_range', '[ 1:22 ]', ...
			'--n_train', '30000', ...
			'--maxploidy', '4.5', ...
			'--minploidy', '1.5', ...
